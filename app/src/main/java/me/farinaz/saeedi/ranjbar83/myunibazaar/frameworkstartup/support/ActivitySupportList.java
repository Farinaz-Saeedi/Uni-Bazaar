...
public abstract class ActivitySupportList<T> extends ArrayAdapter<T> {
    private LayoutInflater inflater;

    public ActivitySupportList(Context context, ArrayList<T> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.adapter_support, parent, false);
