...
public class ActivityRecommended extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.toolbar_recomm);
        ...
        ListView listProducts = findViewById(R.id.list_recomm_product);
